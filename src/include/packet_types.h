 ...
 * has_sig: Whether or not the block has a cryptographic signature
 * type: The type of block
 * subtype: The block type's subtype
 * dest: The device address of the destination
 */
